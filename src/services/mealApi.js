...
export const fetchMeals = async (ingredient) => fetchData(`https://www.themealdb.com/api/json/v1/1/filter.php?i=${ingredient}`);
...
export const fetchDrinks = async (ingredient) => fetchData(`https://www.thecocktaildb.com/api/json/v1/1/filter.php?i=${ingredient}`);
